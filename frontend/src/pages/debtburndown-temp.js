...
function DebtBurnDown() {
  ...
  const [minPrincipalPayment, setMinPrincipalPayment] = useState(0);
  const [principalPmt, setPrincipalPmt] = useState(0);
  const [interestRate, setInterestRate] = useState("");
  const [prevInterestOwed, setPrevInterestOwed] = useState(0);
  const [interestOwed, setInterestOwed] = useState(0);
  const [prevIntPmt, setPreIntPmt] = useState(0);
  const [intPmt, setIntPmt] = useState(0);
  const [totalMinimumPayment, setTotalMinimumPayment] = useState(0);
  const [totalMaximumPayment, setTotalMaximumPayment] = useState(0);
  const [pmtPlaceholder, setPmtPlaceholder] = useState("");
  ...
  const [atLeastOnePmtMade, setAtLeastOnePmtMade] = useState(false);
  const [historyHeaderDisplay, setHistoryHeaderDisplay] = useState("none");
  ...
  useEffect(() => {
    localStorage.setItem("prevPrincipal", prevPrincipal);
    localStorage.setItem("principal", principal);
    localStorage.setItem("minPrincipalPayment", minPrincipalPayment);
    localStorage.setItem("principalPmt", principalPmt);
    localStorage.setItem("interestRate", interestRate);
    localStorage.setItem("prevInterestOwed", prevInterestOwed);
    localStorage.setItem("interestOwed", interestOwed);
    localStorage.setItem("prevIntPmt", prevIntPmt);
    localStorage.setItem("intPmt", intPmt);
    localStorage.setItem("totalMinimumPayment", totalMinimumPayment);
    localStorage.setItem("totalMaximumPayment", totalMaximumPayment);
    localStorage.setItem("pmtPlaceholder", pmtPlaceholder);
    localStorage.setItem("payment", payment);
    localStorage.setItem("prevBalance", prevBalance);
    localStorage.setItem("totalBalance", totalBalance);
    localStorage.setItem("newBalance", newBalance);
    localStorage.setItem("transactionNumber", transactionNumber);
    localStorage.setItem("paymentsArray", paymentsArray);
    localStorage.setItem("paymentDate", paymentDate);
    localStorage.setItem("isAbleToPay", isAbleToPay);
    localStorage.setItem("atLeastOnePmtMade", atLeastOnePmtMade);
    localStorage.setItem("historyHeaderDisplay", historyHeaderDisplay);
    localStorage.setItem("isDebtFree", isDebtFree);
  }, [
    prevPrincipal,
    principal,
    minPrincipalPayment,
...
const setPaymentFieldPlaceholder = () => {
  let totalBalance =
    this.state.principal +
    (this.state.principal * Number(this.state.interestRate)) / 100 / 12;
  let placeholder;
